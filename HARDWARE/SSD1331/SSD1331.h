...
#define SSD1331_RES_PIN         GPIO_Pin_7
#define SSD1331_DC_PIN          GPIO_Pin_4
#define SSD1331_CS_PIN          GPIO_Pin_5

#define SSD1331_RES_GPIO        GPIOA
#define SSD1331_DC_GPIO         GPIOC
#define SSD1331_CS_GPIO         GPIOC
...
#define __SSD1331_WRITE_BYTE(__DATA) SPI2_ReadWriteByte(__DATA)
